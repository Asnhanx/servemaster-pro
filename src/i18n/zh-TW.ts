...
export const zhTW: Translations = deepMerge(zhCN, {
    ...
    support: {
        ...
        quickLink1Desc: '從開箱到進階', quickLink2Desc: '常見問題解決方案', quickLink3Title: '保固與維修', quickLink3Desc: '保固政策查詢',
        contactTitle: '沒有找到您需要的答案？', contactSubtitle: '我們的技術支援團隊隨時準備為您提供幫助。',
        contactFormTitle: '提交支援工單', contactFormSubtitle: '我們將在 24 小時內回覆。',
        contactSubmit: '提交工單', contactSubmitting: '提交中...',
        contactAiTitle: '線上客服', contactAiButton: '開始對話',
        contactEmailTitle: '傳送郵件', contactEmailButton: '傳送郵件',
    },
    ...
    chat: { title: 'ServeMaster AI 助手', online: '線上', disclaimer: 'AI 回覆僅供參考，如需更專業的幫助，請提交工單聯繫人工客服。', back: '返回' },
