      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://v.douyin.com/soBx2FQRRCA/ 9@9.com :3pm" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-surface-border flex items-center justify-center text-text-secondary hover:bg-primary hover:text-black transition-all" title="抖音 (Douyin)">
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
                  <path d="M20.25 5.531c-3.125 0-5.875-2.031-6.75-5.031h-4.25v14.406c0 1.969-1.594 3.563-3.563 3.563-1.969 0-3.563-1.594-3.563-3.563 0-1.969 1.594-3.563 3.563-3.563.469 0 .906.094 1.344.25v-4.406c-.438-.063-.906-.125-1.344-.125-4.375 0-7.938 3.563-7.938 7.938S1.313 22.938 5.688 22.938s7.938-3.563 7.938-7.938V9.125c1.781 1.719 4.188 2.813 6.844 2.938v-4.156c-.063 0-.156.031-.219.031z" />
                </svg>
              </a>
              <a href="https://space.bilibili.com/your_id" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-surface-border flex items-center justify-center text-text-secondary hover:bg-primary hover:text-black transition-all" title="哔哩哔哩 (Bilibili)">
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
        ...
        <div className="border-t border-surface-border pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-text-secondary text-sm mb-4 md:mb-0">
            &copy; 2026 ServeMaster Technologies. All rights reserved.
          </p>
