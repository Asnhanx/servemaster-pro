                      ...
                      <div className="p-8 space-y-6">
                          <div>
                              ...
                              <div className="flex justify-between items-end border-b border-border-dark pb-2">
                                  ...
                                  <span className="font-bold text-lg">140 km/h</span>
                              </div>
                              <div className="flex justify-between items-end border-b border-border-dark pb-2 mt-4">
                                  ...
                                  <span className="font-bold text-lg">30 km/h</span>
                              </div>
                              <div className="flex justify-between items-end border-b border-border-dark pb-2 mt-4">
                                  <span className="text-text-secondary">发球频率</span>
                                  <span className="font-bold text-lg">2 - 10 秒/球</span>
                              </div>
                              <div className="flex justify-between items-end border-b border-border-dark pb-2 mt-4">
                                  <span className="text-text-secondary">装球容量</span>
                                  <span className="font-bold text-lg">150 颗</span>
                              </div>
                          </div>
                          ...
                          <div className="pt-4">
                              ...
                              <div className="flex justify-between items-end border-b border-border-dark pb-2">
                                  ...
                                  <span className="font-bold text-lg">上旋 / 下旋 / 平击</span>
                              </div>
                              <div className="flex justify-between items-end border-b border-border-dark pb-2 mt-4">
                                  <span className="text-text-secondary">仰角调节</span>
                                  <span className="font-bold text-lg">0° - 50° (电子调节)</span>
                              </div>
                              <div className="flex justify-between items-end border-b border-border-dark pb-2 mt-4">
                                  <span className="text-text-secondary">水平摆动</span>
                                  <span className="font-bold text-lg">全场随机 / 2线 / 3线</span>
                              </div>
                          </div>
                      </div>
                      ...
                      <div className="p-8 space-y-6">
                          <div>
                              ...
                              <div className="flex justify-between items-end border-b border-border-dark pb-2">
                                  ...
                                  <span className="font-bold text-lg">24V 锂离子电池</span>
                              </div>
                              <div className="flex justify-between items-end border-b border-border-dark pb-2 mt-4">
                                  <span className="text-text-secondary">续航时间</span>
                                  <span className="font-bold text-lg">4 - 6 小时</span>
                              </div>
                              <div className="flex justify-between items-end border-b border-border-dark pb-2 mt-4">
                                  <span className="text-text-secondary">充电时间</span>
                                  <span className="font-bold text-lg">3 小时 (快充)</span>
                              </div>
                              <div className="flex justify-between items-end border-b border-border-dark pb-2 mt-4">
                                  <span className="text-text-secondary">交流电源</span>
                                  <span className="font-bold text-lg">支持边充边用</span>
                              </div>
                          </div>
                          ...
                          <div className="pt-4">
                              ...
                              <div className="flex justify-between items-end border-b border-border-dark pb-2">
                                  ...
                                  <span className="font-bold text-lg">18 kg</span>
                              </div>
                              <div className="flex justify-between items-end border-b border-border-dark pb-2 mt-4">
                                  <span className="text-text-secondary">尺寸 (收纳)</span>
                                  <span className="font-bold text-lg">50 x 35 x 45 cm</span>
                              </div>
                              <div className="flex justify-between items-end border-b border-border-dark pb-2 mt-4">
                                  <span className="text-text-secondary">控制方式</span>
                                  <span className="font-bold text-lg">App / 遥控器 / Apple Watch</span>
                              </div>
                          </div>
                      </div>
                  </div>
